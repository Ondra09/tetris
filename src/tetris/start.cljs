(ns tetris.start
  (:require [tetris.core :as c]
            [play-cljc.gl.core :as pc]
            [goog.events :as events])
  (:require-macros [tetris.music :refer [build-for-cljs]]))
...
(defonce next-tetris (js/document.querySelector "#next-tetris"))

(set! (.-onclick next-tetris)
      (fn [e]
           (-> next-tetris
               (.-innerHTML)
               (set! "AA"))))
